...
class HierarquiaService:
    ...
    def get_empresa(self, empresa_id: UUID) -> Optional[EmpresaResponse]:
    ...
    def get_area_hierarquia(self, area_id: UUID) -> Optional[HierarquiaCompleta]:
    ...
    def get_contagem_funcionarios(self, empresa_id: UUID) -> List[ContagemPorArea]:
        ...
        return [
            ContagemPorArea(
                ...
                total_funcionarios=c['total_funcionarios']
            )
            for c in contagens
        ]
