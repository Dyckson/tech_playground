...
class TestFuncionarioRepository:
    ...
    def test_get_funcionarios_paginado_success(self, repository, mock_db_connection, mock_cursor, fake_funcionarios_list):
    ...
    def test_get_funcionarios_paginado_with_filters(self, repository, mock_db_connection, mock_cursor, funcionario_data):
    ...
    def test_get_funcionarios_paginado_with_all_filters(self, repository, mock_db_connection, mock_cursor, funcionario_data):
    ...
    def test_get_areas_unicas(self, repository, mock_db_connection, mock_cursor):
        ...
        # Arrange
        areas = [
            {'id': str(AREA_ID), 'nome': 'AWS'},
            {'id': str(UUID(int=2)), 'nome': 'Azure'}
        ]
...
class TestHierarquiaRepository:
    ...
    def test_get_areas_by_empresa(self, repository, mock_db_connection, mock_cursor, area_hierarquia_data):
        ...
        # Arrange
        areas = [
            area_hierarquia_data,
            {**area_hierarquia_data, 'id': str(UUID(int=2)), 'nome': 'Azure'}
        ]
        mock_cursor.fetchall.return_value = areas
